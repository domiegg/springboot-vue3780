...
public class JiaoshiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JiaoshiEntity u = jiaoshiService.selectOne(new EntityWrapper<JiaoshiEntity>().eq("jiaoshixingming", username));
    ...
    public R register(@RequestBody JiaoshiEntity jiaoshi){
    	...
    	JiaoshiEntity u = jiaoshiService.selectOne(new EntityWrapper<JiaoshiEntity>().eq("jiaoshixingming", jiaoshi.getJiaoshixingming()));
		if(u!=null) {
