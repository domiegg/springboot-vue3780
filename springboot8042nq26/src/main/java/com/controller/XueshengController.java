...
public class XueshengController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		XueshengEntity u = xueshengService.selectOne(new EntityWrapper<XueshengEntity>().eq("xingming", username));
    ...
    public R register(@RequestBody XueshengEntity xuesheng){
    	...
    	XueshengEntity u = xueshengService.selectOne(new EntityWrapper<XueshengEntity>().eq("xingming", xuesheng.getXingming()));
		if(u!=null) {
