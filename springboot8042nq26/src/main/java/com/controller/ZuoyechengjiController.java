...
public class ZuoyechengjiController {
    ...
    public R page(@RequestParam Map<String, Object> params,ZuoyechengjiEntity zuoyechengji,
		...
		if(tableName.equals("xuesheng")) {
			zuoyechengji.setXingming((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jiaoshi")) {
			zuoyechengji.setJiaoshixingming((String)request.getSession().getAttribute("username"));
		}
    ...
    public R fenshuSectionStat(HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = zuoyechengjiService.fenshuSectionStat(params, ew);
        return R.ok().put("data", result);
    }
