...
<div class="content" :style='{"minHeight":"calc(100vh - 200px)","padding":"0px 30px 30px","margin":"0 auto","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230831/c5c18c4ebc614a97b159eb53953cee14.png) no-repeat center top / cover,#f5f5f5","display":"flex","width":"calc(100% - 60px)","fontSize":"16px","height":"100%"}'>
	...
	<!-- statis -->
	<div :style='{"padding":"0","boxShadow":"0 0px 0px 0px rgba(100,100,100,.05)","margin":"0 0px 30px 0px","borderColor":"#fceaee","alignItems":"center","color":"#666","display":"flex","justifyContent":"center","borderRadius":"3px","flexWrap":"wrap","background":"none","borderWidth":"0px","width":"100%","fontSize":"14px","borderStyle":"double","order":"1"}'>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"0 10px 0 0","margin":"0 0 10px 0","borderColor":"#f0f0f0","borderRadius":"3px","textAlign":"center","background":"rgba(255, 255, 255,1)","borderWidth":"1px","display":"flex","width":"20%","borderStyle":"solid","justifyContent":"center"}' v-if="isAuth('yuyueshenqing','首页总数')">
			<div :style='{"width":"80px","alignItems":"center","background":"none","justifyContent":"center","display":"flex","height":"83px"}'>
				<span class="icon iconfont icon-tongji18" :style='{"color":"#2aca76","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"#2aca76","fontWeight":"bold","height":"24px"}'>{{yuyueshenqingCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"#2aca76","height":"24px"}'>预约申请总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"0 10px 0 0","margin":"0 0px 10px 0","borderColor":"#f0f0f0","borderRadius":"3px","textAlign":"center","background":"#fff","borderWidth":"1px","display":"flex","width":"20%","borderStyle":"solid","justifyContent":"center"}' v-if="isAuth('shiyongjilu','首页总数')">
			<div :style='{"width":"80px","alignItems":"center","background":"none","justifyContent":"center","display":"flex","height":"83px"}'>
				<span class="icon iconfont icon-tongji9" :style='{"color":"#ea8557","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"#ea8557","fontWeight":"bold","height":"24px"}'>{{shiyongjiluCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"#ea8557","height":"24px"}'>使用记录总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"0 10px 0 0","margin":"0 0px 10px 0","borderColor":"#f0f0f0","borderRadius":"3px","textAlign":"center","background":"rgba(255, 255, 255,1)","borderWidth":"1px","display":"flex","width":"20%","borderStyle":"solid","justifyContent":"center"}' v-if="isAuth('zuoyechengji','首页总数')">
			<div :style='{"width":"80px","alignItems":"center","background":"none","justifyContent":"center","display":"flex","height":"83px"}'>
				<span class="icon iconfont icon-tongji18" :style='{"color":"#53b5e6","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"#53b5e6","fontWeight":"bold","height":"24px"}'>{{zuoyechengjiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"#53b5e6","height":"24px"}'>作业成绩总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<div class="type5" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"3"}'>
		<div id="yuyueshenqingChart1" class="echarts1" v-if="isAuth('yuyueshenqing','首页统计')"></div>
		<div id="yuyueshenqingChart2" class="echarts2" v-if="isAuth('yuyueshenqing','首页统计')"></div>
		<div id="shiyongjiluChart1" class="echarts3" v-if="isAuth('shiyongjilu','首页统计')"></div>
		<div id="zuoyechengjiChart1" class="echarts4" v-if="isAuth('zuoyechengji','首页统计')"></div>
		<div id="zuoyechengjiChart2" class="echarts5" v-if="isAuth('zuoyechengji','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
export default {
	...
	mounted(){
		this.init();
		this.getyuyueshenqingCount();
		this.yuyueshenqingChat1();
		this.yuyueshenqingChat2();
		this.getshiyongjiluCount();
		this.shiyongjiluChat1();
		this.getzuoyechengjiCount();
		this.zuoyechengjiChat1();
		this.zuoyechengjiChat2();
	},
	methods:{
		// 词云
		...
		getyuyueshenqingCount() {
			this.$http({
				url: `yuyueshenqing/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.yuyueshenqingCount = data.data
				}
			})
		},
		yuyueshenqingChat1() {
        ...
        var yuyueshenqingChart1 = echarts.init(document.getElementById("yuyueshenqingChart1"),'roma');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                yuyueshenqingChart1.setOption(option);
				// 动画效果
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    yuyueshenqingChart1.resize();
                };
            }
        });
      })
    ...
    yuyueshenqingChat2() {
      this.$nextTick(()=>{
        ...
        var yuyueshenqingChart2 = echarts.init(document.getElementById("yuyueshenqingChart2"),'roma');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                yuyueshenqingChart2.setOption(option);
				
				// 动画效果
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    yuyueshenqingChart2.resize();
                };
            }
        });
      })
		...
		getshiyongjiluCount() {
			this.$http({
				url: `shiyongjilu/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.shiyongjiluCount = data.data
				}
			})
		},
		shiyongjiluChat1() {
        ...
        var shiyongjiluChart1 = echarts.init(document.getElementById("shiyongjiluChart1"),'roma');
        this.$http({
            url: `shiyongjilu/value/shiyanshihao/shiyongrenshu`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                shiyongjiluChart1.setOption(option);
				// 动画效果
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    shiyongjiluChart1.resize();
                };
            }
        });
      })
		...
		getzuoyechengjiCount() {
			this.$http({
				url: `zuoyechengji/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.zuoyechengjiCount = data.data
				}
			})
		},
		zuoyechengjiChat1() {
        ...
        var zuoyechengjiChart1 = echarts.init(document.getElementById("zuoyechengjiChart1"),'roma');
        this.$http({
            url: "zuoyechengji/sectionStat/fenshu",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
				...
				// 动画效果
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, zuoyechengjiChart1)
    ...
    zuoyechengjiChat2() {
      this.$nextTick(()=>{
        ...
        var zuoyechengjiChart2 = echarts.init(document.getElementById("zuoyechengjiChart2"),'roma');
        this.$http({
            url: "zuoyechengji/group/chengji",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                zuoyechengjiChart2.setOption(option);
				
				// 动画效果
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    zuoyechengjiChart2.resize();
                };
            }
        });
      })
