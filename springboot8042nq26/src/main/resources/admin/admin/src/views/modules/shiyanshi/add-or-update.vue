	...
	<div class="addEdit-block" :style='{"minHeight":"calc(100vh - 200px)","padding":"30px","margin":"0 auto","color":"#666","background":"#f5f5f5","width":"calc(100% - 60px)","fontSize":"16px","height":"100%"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' class="select" v-if="type!='info'"  label="实验室类型" prop="shiyanshileixing">
					<el-select :disabled="ro.shiyanshileixing" v-model="ruleForm.shiyanshileixing" placeholder="请选择实验室类型" >
						<el-option
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' class="input" v-if="type!='info'"  label="开放时间" prop="kaifangshijian">
					<el-input v-model="ruleForm.kaifangshijian" placeholder="开放时间" clearable  :readonly="ro.kaifangshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' v-else class="input" label="开放时间" prop="kaifangshijian">
					<el-input v-model="ruleForm.kaifangshijian" placeholder="开放时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' class="input" v-if="type!='info'"  label="座位数量" prop="zuoweishuliang">
					<el-input v-model.number="ruleForm.zuoweishuliang" placeholder="座位数量" clearable  :readonly="ro.zuoweishuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' v-else class="input" label="座位数量" prop="zuoweishuliang">
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' v-if="type!='info'"  label="实验室详情" prop="shiyanshixiangqing">
					<editor 
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' v-else-if="ruleForm.shiyanshixiangqing" label="实验室详情" prop="shiyanshixiangqing">
                    <span :style='{"fontSize":"16px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.shiyanshixiangqing"></span>
                </el-form-item>
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.$http({
				url: `option/shiyanshileixing/shiyanshileixing`,
				method: "get"
            }).then(({ data }) => {
				if (data && data.code === 0) {
					this.shiyanshileixingOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.shiyanshixiangqing = this.ruleForm.shiyanshixiangqing.replace(reg,'../../../springboot8042nq26/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
