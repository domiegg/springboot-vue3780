	...
	<div class="addEdit-block" :style='{"minHeight":"calc(100vh - 200px)","padding":"30px","margin":"0 auto","color":"#666","background":"#f5f5f5","width":"calc(100% - 60px)","fontSize":"16px","height":"100%"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' class="input" v-if="type!='info'"  label="使用人数" prop="shiyongrenshu">
					<el-input v-model.number="ruleForm.shiyongrenshu" placeholder="使用人数" clearable  :readonly="ro.shiyongrenshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' v-else class="input" label="使用人数" prop="shiyongrenshu">
					<el-input v-model="ruleForm.shiyongrenshu" placeholder="使用人数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' class="date" v-if="type!='info'" label="使用时间" prop="shiyongshijian">
					<el-date-picker
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' class="input" v-else-if="ruleForm.shiyongshijian" label="使用时间" prop="shiyongshijian">
					<el-input v-model="ruleForm.shiyongshijian" placeholder="使用时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' class="input" v-if="type!='info'"  label="姓名" prop="xingming">
					<el-input v-model="ruleForm.xingming" placeholder="姓名" clearable  :readonly="ro.xingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' v-else class="input" label="姓名" prop="xingming">
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' v-if="type!='info'"  label="使用记录" prop="shiyongjilu">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.shiyongjilu" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' v-else-if="ruleForm.shiyongjilu" label="使用记录" prop="shiyongjilu">
                    <span :style='{"fontSize":"16px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.shiyongjilu"></span>
                </el-form-item>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				shiyongjilu: [
					{ required: true, message: '使用记录不能为空', trigger: 'blur' },
				],
				shiyongshijian: [
				],
				xingming: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='shiyongjilu'){
							this.ruleForm.shiyongjilu = obj[o];
							this.ro.shiyongjilu = true;
							continue;
						}
						if(o=='shiyongshijian'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.shiyongjilu = this.ruleForm.shiyongjilu.replace(reg,'../../../springboot8042nq26/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
