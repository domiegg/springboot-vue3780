	...
	<div class="addEdit-block" :style='{"minHeight":"calc(100vh - 200px)","padding":"30px","margin":"0 auto","color":"#666","background":"#f5f5f5","width":"calc(100% - 60px)","fontSize":"16px","height":"100%"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' class="upload" v-if="type!='info'&& !ro.xuexishipin" label="学习视频" prop="xuexishipin">
					<file-upload
						tip="点击上传学习视频"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' v-else-if="ruleForm.xuexishipin" label="学习视频" prop="xuexishipin">
					<el-button :style='{"border":"0px solid #ccc","cursor":"pointer","padding":"0 30px","margin":"0 20px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#60B8D1","width":"auto","lineHeight":"36px","fontSize":"16px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.xuexishipin)">预览</el-button>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' v-else-if="!ruleForm.xuexishipin" label="学习视频" prop="xuexishipin">
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' v-if="type!='info'"  label="视频介绍" prop="shipinjieshao">
					<editor 
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"#f9f9f9","width":"60%","fontSize":"inherit","height":"auto"}' v-else-if="ruleForm.shipinjieshao" label="视频介绍" prop="shipinjieshao">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.shipinjieshao = this.ruleForm.shipinjieshao.replace(reg,'../../../springboot8042nq26/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
