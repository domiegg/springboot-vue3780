				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('zuoyetijiao','批改作业')" @click="zuoyechengjiCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
...
import zuoyechengjiCrossAddOrUpdate from "../zuoyechengji/add-or-update";
	export default {
		...
		methods: {
			...
			zuoyechengjiCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
