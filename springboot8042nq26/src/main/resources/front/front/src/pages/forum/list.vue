<template>
<div class="forum-preview" :style='{"width":"1200px","padding":"20px","margin":"0 auto","overflow":"hidden","position":"relative","background":"#fff"}'>
    <div :style='{"width":"100%"}'>
	...
	<div class="z-box" :style='{"width":"100%","padding":"20px"}'>
		<div class="section-content" v-for="item in forumList" :key="item.id" @click="toForumDetail(item)">
		  <div :style='{"color":"#333","flex":"1","fontSize":"14px"}' class="item-style">{{item.title}}</div>
