...
<div :style='{"width":"1200px","padding":"20px","margin":"0 auto","overflow":"hidden","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 2% 10px","background":"#fff","display":"inline-block"}' label="资料文件" prop="ziliaowenjian">
            <file-upload
            tip="点击上传资料文件"
            action="file/upload"
            :limit="1"
          ...
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 2% 10px","background":"#fff","display":"inline-block"}' label="发布老师" prop="jiaoshixingming">
            <el-input v-model="ruleForm.jiaoshixingming" 
                placeholder="发布老师" clearable :disabled="true  ||ro.jiaoshixingming"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 2% 10px","background":"#fff","display":"inline-block"}' label="资料内容" prop="ziliaoneirong">
            <editor 
