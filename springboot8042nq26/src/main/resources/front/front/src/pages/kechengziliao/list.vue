...
<div>
	...
	<div v-if="centerType" :style='{"padding":"0 0px","margin":"0","borderRadius":"0","alignItems":"center","background":"rgba(0,0,0,0.5)","display":"flex","width":"100%","justifyContent":"center","height":"60px"}'>
		<el-button size="mini" @click="backClick">返回</el-button>
	</div>
	<div class="list-preview" :style='{"width":"1200px","margin":"0px auto","overflow":"hidden","flexWrap":"wrap","background":"#fff","display":"flex"}'>
		<div class="category-3" :style='{"border":"1px solid #000","padding":"0","margin":"20px 0 36px 20px","alignItems":"flex-start","background":"#fff","flexDirection":"column","display":"flex","width":"200px","height":"auto","order":"6"}'>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","margin":"20px 0 0","alignItems":"center","flexWrap":"wrap","background":"#fff","display":"flex","width":"calc(100% - 0px)","height":"auto","order":"2"}'>
	  ...
	  <el-button v-if="btnAuth('kechengziliao','新增')" :style='{"cursor":"pointer","border":"1px solid #170000","padding":"0px 15px","margin":"0 10px 0 0","outline":"none","color":"#000","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/kechengziliaoAdd')"><i v-if="true" :style='{"color":"#000","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	<div class="select2" :style='{"padding":"0 10px","margin":"20px 0 0","background":"#fff","width":"calc(100% - 0px)","float":"left","height":"auto","order":"1"}'>
	...
	<div class="sort_view" :style='{"border":"1px solid #000","boxShadow":" 0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"0","borderRadius":"0 0 10px 10px","alignItems":"center","top":"699px","left":"20%","display":"flex","width":"100%","justifyContent":"center","order":"0","height":"90px"}'>
	</div>
	<div class="list" :style='{"minHeight":"480px","width":"calc(100% - 240px)","margin":"20px 0 10px","background":"#fff","flex":"1","order":"5"}'>
		
		<!-- 样式三 -->
		<div class="list3 index-pv1" :style='{"padding":"0 10px","alignItems":"flex-start","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		  <div v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
		    <div :style='{"border":"0px solid #fff","width":"45%","padding":"8px","overflow":"hidden","height":"220px"}' class="img-box">
		    ...
		    <div :style='{"padding":"0 10px","overflow":"hidden","alignItems":"center","flex":"1","display":"flex","height":"auto"}' class="item-info">
		      <div :style='{"width":"auto","padding":"0 10px 0 0","flexDirection":"column","flex":"1","display":"flex"}'>
		        ...
		        <div :style='{"padding":"0 10px","borderColor":"red","borderStyle":"solid","borderWidth":"0","order":"1"}' class="publisher">
		          ...
		          <span class="text">{{item.jiaoshixingming}}</span>
		        </div>
		      ...
		      <div class="desc" v-html="item.ziliaoneirong"></div>
		    </div>
		  </div>
		</div>
	</div>
	...
	<!-- 热门信息 -->
	<div class="hot" :style='{"border":"1px solid #333","width":"100%","margin":"20px 0 0","background":"#fff","height":"auto","order":"50"}'>
	  <div :style='{"padding":"5px","color":"#fff","textAlign":"center","background":"#ff721b","width":"100%","lineHeight":"44px","fontSize":"16px"}'>热门信息</div>
	  <div :style='{"padding":"5px","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
	    <div v-for="item in hotList" :key="item.id" :style='{"cursor":"pointer","width":"23%","padding":"5px 8px","background":"#fff","height":"auto"}' @click="toDetail(item)">
	      <img :style='{"width":"100%","objectFit":"cover","display":"block","height":"150px"}' v-if="item.tupian && item.tupian.substr(0,4)=='http'" :src="item.tupian.split(',')[0]" alt="">
	      <img :style='{"width":"100%","objectFit":"cover","display":"block","height":"150px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="">
	      <div :style='{"padding":"4px","lineHeight":"1","fontSize":"14px","color":"#000","textAlign":"center"}'>{{item.kechengmingcheng}}</div>
	      <div :style='{"padding":"4px","lineHeight":"1","fontSize":"14px","color":"#000","textAlign":"center"}'>{{item.kechengleixing}}</div>
...
<script>
  export default {
    ...
    methods: {
      ...
      getHotList() {
        let autoSortUrl = "";
        autoSortUrl = "kechengziliao/autoSort";
        if(localStorage.getItem('frontToken')) {
            autoSortUrl = "kechengziliao/autoSort2";
        }
      ...
      getList(page, fenlei, ref = '') {
        ...
        this.$http.get(`kechengziliao/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        ...
        this.$router.push({path: '/index/kechengziliaoDetail', query: params});
      },
