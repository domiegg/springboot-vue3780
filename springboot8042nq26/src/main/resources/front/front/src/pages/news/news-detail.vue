<template>
	<div :style='{"width":"1200px","margin":"0px auto","overflow":"hidden","position":"relative","background":"#fff","display":"block"}'>
	...
	<div :style='{"width":"100%","flexWrap":"wrap","justifyContent":"space-between","display":"flex"}'>
		<div :style='{"width":"100%","margin":"0 0 20px","height":"auto"}'>
			<div :style='{"margin":"10px 0 0","fontSize":"20px","lineHeight":"54px","color":"#fff","textAlign":"center","background":"#FF721B"}'>公告信息</div>
		</div>
