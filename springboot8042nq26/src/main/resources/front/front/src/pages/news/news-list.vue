...
<div>
	...
	<div class="news-preview-pv" :style='{"width":"1200px","margin":"0px auto","position":"relative","flexWrap":"wrap","background":"#fff","display":"flex"}'>
		...
		<div class="list2 index-pv1" :style='{"minHeight":"720px","padding":"0 0px","flexWrap":"wrap","background":"#fff","flex":"1","display":"block","width":"100%","height":"auto","order":"3"}'>
			<div :style='{"border":"1px solid #000","cursor":"pointer","padding":"15px","margin":"0px 0 20px 2%","overflow":"hidden","background":"url() no-repeat right bottom","display":"flex","width":"48%","fontSize":"0","position":"relative","float":"left","height":"230px"}' v-for="item in newsList" :key="item.id" @click="toNewsDetail(item)" class="list-item animation-box">
		...
		<!-- 最新动态 -->
		<div class="news" :style='{"border":"1px solid #000","width":"100%","background":"#fff","height":"auto","order":"50"}'>
