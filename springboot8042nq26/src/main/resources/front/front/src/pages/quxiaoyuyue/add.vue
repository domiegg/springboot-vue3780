    ...
    >
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 2% 10px","background":"#fff","display":"inline-block"}' label="实验室号" prop="shiyanshihao">
            <el-input v-model="ruleForm.shiyanshihao" 
                placeholder="实验室号" clearable :disabled="true  ||ro.shiyanshihao"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 2% 10px","background":"#fff","display":"inline-block"}' label="实验室类型" prop="shiyanshileixing">
            <el-input v-model="ruleForm.shiyanshileixing" 
                placeholder="实验室类型" clearable :disabled="true  ||ro.shiyanshileixing"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 2% 10px","background":"#fff","display":"inline-block"}' label="取消人" prop="xingming">
            <el-input v-model="ruleForm.xingming" 
                placeholder="取消人" clearable :disabled="true  ||ro.xingming"></el-input>
          </el-form-item>
