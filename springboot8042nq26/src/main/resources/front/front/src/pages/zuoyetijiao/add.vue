...
<div :style='{"width":"1200px","padding":"20px","margin":"0 auto","overflow":"hidden","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 2% 10px","background":"#fff","display":"inline-block"}' label="提交作业" prop="tijiaozuoye">
            <file-upload
            tip="点击上传提交作业"
            action="file/upload"
            :limit="1"
          ...
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 2% 10px","background":"#fff","display":"inline-block"}' label="提交日期" prop="tijiaoriqi">
              <el-date-picker
				  :disabled="true  ||ro.tijiaoriqi"
